...
sudo tc qdisc add dev s9-eth1 root netem delay 10ms rate 6mbit
sudo tc qdisc add dev s9-eth2 root netem delay 10ms rate 6mbit
sudo tc qdisc add dev s9-eth3 root netem delay 10ms rate 6mbit
sudo tc qdisc add dev s9-eth4 root netem delay 10ms rate 6mbit
...
sudo tc qdisc add dev s11-eth1 root netem delay 10ms rate 8mbit
sudo tc qdisc add dev s11-eth2 root netem delay 10ms rate 8mbit
sudo tc qdisc add dev s12-eth1 root netem delay 10ms rate 8mbit
sudo tc qdisc add dev s12-eth2 root netem delay 10ms rate 8mbit
